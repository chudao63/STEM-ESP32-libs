...
//     : pinVRX(vrxPin), pinVRY(vryPin), rawVrx(0), rawVry(0), vrxValue(0), vryValue(0) {}

// void Joystick::begin(uint8_t swPin) {
//     // Cấu hình nếu cần (ví dụ pinMode cho nút SW nếu có)
//     if (swPin != 255) {
//         pinSW = swPin;
//         pinMode(pinSW, INPUT_PULLUP); // ⭐ RẤT QUAN TRỌNG
//     }
// }
...
// 			// Chỉ cập nhật khi thực sự có thay đổi ổn định
// 			if (reading != swState) {
// 				swState = reading;
// 			}
// 		}
